...
After the NetPlay player starts, both participants use EmulatorJS’s globe menu to set a player name, create or select a room, enter its password, chat, and leave. Internet hosts should use a password-protected room. Required BIOS files remain local and must be selected separately by every participant.
